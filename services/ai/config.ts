...
// this app (chat + cover recognition) — gemini-3.x models require paid AI
// Gateway credits (confirmed via a real 403 "Free tier users do not have
// access to this model" against the account's free tier); gemini-2.5-flash
// is free-tier accessible. Having one shared constant means a future model
// swap (or another free-tier availability change) only needs one edit.
